...
var initApp = function(e) {
        return e.listFilter = function(t, e, o) {
            ...
            return window.innerWidth < myapp_config.mobileResolutionTrigger ? (myapp_config.root_.addClass("mobile-view-activated"), myapp_config.mobileMenuTrigger = !0) : (myapp_config.root_.removeClass("mobile-view-activated"), myapp_config.mobileMenuTrigger = !1), myapp_config.debugState, myapp_config.mobileMenuTrigger
            ...
            $(".custom-file input").change(function(e) {
                ...
                allowPageScroll: !1,
                disableFadeOut: !1
            }), myapp_config.debugState) : (console.log("WARN! $.fn.slimScroll not loaded or user is on desktop"), myapp_config.root_.addClass("no-slimscroll")), void 0 !== initApp.listFilter && $.isFunction(initApp.listFilter) && $("[data-listfilter]").length && (n = $("[data-listfilter]").attr("id"), i = $("[data-listfilter]").attr("data-listfilter"), initApp.listFilter(i, "#" + n)), void 0 !== $.fn.tooltip && $('[data-toggle="tooltip"]').length ? $('[data-toggle="tooltip"]').tooltip() : console.log("OOPS! bs.tooltip is not loaded"), void 0 !== $.fn.popover && $('[data-toggle="popover"]').length && ($.fn.tooltip.Constructor.Default.whiteList, $('[data-toggle="popover"]').popover({
                sanitize: !1
                ...
                switch (!0) {
                    ...
                    case "panel-close" === o:
                        ...
                        "undefined" != typeof bootbox ? (initApp.playSound("media/sound", "messagebox"), bootbox.confirm({
                            title: "<i class='" + myapp_config.appIconPrefix + " fa-times-circle text-danger mr-2'></i> Uyarı",
                            message: "Seçili ekranı silmek istiyor musunuz <span class='fw-500'>&nbsp;'" + r.children(".panel-hdr").children("h2").text().trim() + "'&nbsp;</span>?",
            ...
            }), navigator.userAgent.match(/IEMobile\/10\.0/) && ((a = document.createElement("style")).appendChild(document.createTextNode("@-ms-viewport{width:auto!important}")), document.head.appendChild(a)), myapp_config.debugState
        }, e
    }({}),
    layouts = function(e) {
...
$(window).resize($.throttle(myapp_config.throttleDelay, function(e) {
    ...
    if ($(this).data("prevType") != e.type) switch (e.type) {
        case "blur":
            myapp_config.root_.toggleClass("blur"), myapp_config.debugState;
            break;
        case "focus":
            myapp_config.root_.toggleClass("blur"), myapp_config.debugState;
    }
